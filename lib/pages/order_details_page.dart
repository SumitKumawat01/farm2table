import 'package:farm2table/models/order.dart';
import 'package:farm2table/utils/extensions/date.dart';
import 'package:farm2table/widgets/order_item.dart';
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Row(
                    children: [
                      Icon(CupertinoIcons.home, size: 15),
                      SizedBox(width: 5),
                      Expanded(
                        child: Text(
